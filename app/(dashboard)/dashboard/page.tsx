...
const dashboardCopy: Record<Locale, DashboardCopy> = {
  sr: {
    ...
    emptyText: "Započnite unosom proizvoda, količine i destinacije.",
  ...
  de: {
    ...
    emptyText: "Beginnen Sie mit Produkt, Menge und Zielland.",
  ...
  en: {
    ...
    emptyText: "Start with the product, quantity, and destination.",
