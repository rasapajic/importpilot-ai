...
const diagnosis = {
  configuration: {
    ...
    tajaOpenAIModel: providerEnv.OPENAI_SEARCH_MODEL || "gpt-5-mini",
    tajaOpenAIReasoningEffort: providerEnv.OPENAI_REASONING_EFFORT || "minimal",
    tajaOpenAIMaxResults: Number(providerEnv.OPENAI_SEARCH_MAX_RESULTS || 3),
    tajaOpenAITimeoutMs: Number(providerEnv.OPENAI_SEARCH_TIMEOUT_MS || 45_000),
    tajaOpenAISearchContextSize: providerEnv.OPENAI_SEARCH_CONTEXT_SIZE || "low",
  },
